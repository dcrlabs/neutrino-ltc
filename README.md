# Neutrino: Privacy-Preserving Bitcoin Light Client (Litecoin Cash fork)

[![Build Status](https://travis-ci.org/ltcsuite/neutrino.svg?branch=master)](https://travis-ci.org/ltcsuite/neutrino)
[![Godoc](https://godoc.org/github.com/dcrlabs/neutrino-ltc?status.svg)](https://godoc.org/github.com/dcrlabs/neutrino-ltc)
[![Coverage Status](https://coveralls.io/repos/github/dcrlabs/neutrino-ltc/badge.svg?branch=master)](https://coveralls.io/github/dcrlabs/neutrino-ltc?branch=master)
